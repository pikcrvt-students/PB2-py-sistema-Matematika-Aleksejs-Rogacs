''' Programmu izveidoja Aleksejs Rogačs DP1-1
Programma  izstrādāta, lai palīdzētu matemātikas skolotājam pārbaudīt \
skolēnu zināšanas par tēmu "Kvadrātvienādojums un augstāku pakāpju vienādojumi".
'''
import time

print('Labdien, student! Šodien Jūms ir jāiepazīstas ar tādu tēmu kā \
...
input('Nospiediet Enter, lai pariet uz nākamo uzdevumu.\n\n')
input('Šeit sākas parbaudes darbs. Būs 5 uzdevumi. Par katru pareizi atrisinātu \
uzdevumu tiek doti 2 punkti.1 punkts - 1 balle. Pēc visu uzdevumu izpildes \
...
Pirmkart ievadi mazāko skaitli.(platums)\
Par uzdevumu var dabūt 2 punktus.\n')
    pareiz_atbilde1= 6
    pareiz_atbilde2= 15
